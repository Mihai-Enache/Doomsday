...
public class PlayerScript1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        MeshRenderer mesh = Mothership.GetComponentInChildren<MeshRenderer>();
        mesh.material.color = Color.gray;
        Mothership.GetComponent<ShipScript>().owner = 1;
    ...
    public void BuildShip(GameObject Hex)
    {
        if (resources >= 2000)
        {
            ...
            MeshRenderer mesh = Ships[shipsNr].GetComponentInChildren<MeshRenderer>();
            mesh.material.color = Color.gray;
            Ships[shipsNr].GetComponent<ShipScript>().owner = 1;
